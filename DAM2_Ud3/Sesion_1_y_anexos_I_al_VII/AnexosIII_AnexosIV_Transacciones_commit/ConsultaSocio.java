package AnexosIII_AnexosIV_Transacciones_commit;
		...
		public void actionPerformed(ActionEvent event) {
			...
			if (rs != null) {
				...
				if(event.getSource() == buscar) { //Buscar
					posicion = 1;
					etiqConteo.setText("Socio " + posicion + " de " + ultimo);
					rs.absolute(posicion);
					
					cajaId.setText(String.valueOf(rs.getInt(1)));
					cajaNombre.setText(rs.getString(2));
					cajaEstatura.setText(String.valueOf(rs.getInt(3)));
					cajaEdad.setText(String.valueOf(rs.getInt(4)));
					cajaLocalidad.setText(rs.getString(5));
				}
