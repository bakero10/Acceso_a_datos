...
public class ConsultaSocio extends JFrame {
	...
	class OyenteBoton implements ActionListener {
		public void actionPerformed(ActionEvent event) {
			...
			abd.conectar();
			List<Socio> lista = abd.consultaLocalidad(caja6.getText());		//hacemos una lista de socios recogiendo la localidad de la caja6
			...
			if (lista != null) {
				...
				if(event.getSource() == boton3) { //Buscar
					...
					Socio s = lista.get(posicion);
					
					caja1.setText(String.valueOf(s.getSocioId()));
					caja2.setText(String.valueOf(s.getNombre()));
					caja3.setText(String.valueOf(s.getEstatura()));
					caja4.setText(String.valueOf(s.getEdad()));
					caja5.setText(String.valueOf(s.getLocalidad()));
				}
