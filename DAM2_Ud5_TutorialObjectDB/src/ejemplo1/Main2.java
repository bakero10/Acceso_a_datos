...
public class Main2 {
	...
	// System.out.println(abd.incrementarSalario(1));
	// System.out.println(abd.incrementarSalarioOficio("Empleado",1));
	// System.out.println(abd.incrementarSalarioDepartamento(10,1));
	// System.out.println(abd.borrarEmpleado(1039));
	// System.out.println(abd.borrarDepartamentoJPQL(10));
